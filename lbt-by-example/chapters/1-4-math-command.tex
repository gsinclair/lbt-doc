\begin{lbt}
  ...
  [+BODY]
    ...
    TEXT Sometimes you want to interrupt a sequence of aligned equations to provide a line or even paragraph of commentary. This is achieved with the ◊amsmath command ◊intertext or (if tighter vertical spacing is desired) the ◊mathtools command ◊shortintertext. In ◊lbt you can use these as you would in plain Latex, or you can use the more ◊lbt-ish versions \code{TEXT} and \code{SHORTTEXT}. \cref{ex:math-align-intertext} demonstrates.
    ...
    LATEX \FloatBarrier
    SECTION (label) sec:math-additional :: \code{Additional environments}
