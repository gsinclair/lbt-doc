\begin{lbt}
  ...
  [+BODY]
    ...
    :: .v <<
      ...
      :: \intertext{Multiply both sides by $r\,$:}
      :: r S_n &= ar + ar^2 + ar^3 + dots + ar^n
      :: \intertext{Now subtract the second equation from the first:}
      :: S_n - r S_n &= (a + ar + ar^2 + dots + ar^{n-1}) - (ar + ar^2 + dots + ar^n)
      :: \intertext{All terms cancel except the first and the last:}
      :: (1 - r) S_n &= a - ar^n
      :: \intertext{Finally, divide both sides by $1-r$ (assuming $r \neq 1$):}
